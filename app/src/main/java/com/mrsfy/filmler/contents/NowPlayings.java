 ...
 */
public class NowPlayings implements ContentStrategy{
    Context context;
    ...
    public void NowPlayings(Context context){
        setContext(context);
    }

    public void NowPlayings(){
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            for (int i = 0; i < moviesArray.length(); i++){
                                ...
                                Storage.getNowPlayings().add(new Movie(
                                        movieObj.getInt("id"),
                            ...
                            for (Movie movie : Storage.getNowPlayings()) {
                                Log.i("Now Playing Movie # "+ movie.getId(), movie.getTitle());
                            }
                            progress.dismiss();
                        } catch (Exception e) {
                            e.printStackTrace();
