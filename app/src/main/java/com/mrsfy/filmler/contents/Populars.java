 ...
 */
public class Populars implements ContentStrategy{
    Context context;
    ...
    public void Populars(Context context){
        setContext(context);
    }
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            for (int i = 0; i < moviesArray.length(); i++){
                                ...
                                Storage.getPopulars().add(new Movie(
                                        movieObj.getInt("id"),
                            ...
                            for (Movie movie : Storage.getPopulars()) {
                                Log.i("Popular Movie # "+ movie.getId(), movie.getTitle());
                            }
                            progress.dismiss();
                        } catch (Exception e) {
                            e.printStackTrace();
